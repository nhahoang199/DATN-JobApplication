...
function EditCompanySkillDrawerForm() {
    const dispatch = useAppDispatch()
    const openEditCompanySkill = useSelector((state: RootState) => state.companyProfileSlice.openEditCompanySkill)
    return (
        <Drawer
            open={openEditCompanySkill}
            className='p-4'
            onClose={() => dispatch(setOpenEditCompanySkill(false))}
            size={800}
            placement='right'
            ...
            <div className='mt-12'>
                <div className='mb-6 flex items-center justify-between'>
                    <Typography variant='h5' color='blue-gray'>
                        Chỉnh sửa chuyên môn của công ty
                    </Typography>
                    <IconButton
                        variant='text'
                        color='blue-gray'
                        onClick={() => dispatch(setOpenEditCompanySkill(false))}
                    >
                        <svg
                ...
                <form className='mt-4 w-full flex flex-col gap-y-2'>
                    <div className='mb-1 flex flex-col gap-4 w-full'>
                        <Typography variant='h6' color='blue-gray' className='-mb-2 flex flex-row gap-x-2 font-medium'>
                            ...
                            Viết các chuyên môn chính của công ty
                        </Typography>
                        <CKEditor
...
export default EditCompanySkillDrawerForm
