...
export default function Footer() {
    return (
        <footer className='relative w-full py-12 bg-gray-100'>
            <div className='w-full px-8 mx-auto max-w-screen-3xl'>
                <div className='grid justify-between grid-cols-1 gap-4 ml-12 md:grid-cols-2'>
                    <img className='object-cover object-center w-80 h-80' src={logo_transparent} alt='Logo' />
                    <div className='grid items-center justify-between grid-cols-3 gap-4'>
