...
function CreateHRForm() {
    ...
    const openCreateHR = useSelector((state: RootState) => state.userProfile.openCreateHR)
    return (
        <Drawer
            open={openCreateHR}
            className='p-4'
            onClose={() => dispatch(setOpenCreateHR(false))}
            placement='right'
        ...
        >
            <div className='mt-12'>
                <div className='mb-6 flex items-center justify-between'>
                    ...
                    <IconButton variant='text' color='blue-gray' onClick={() => dispatch(setOpenCreateHR(false))}>
                        <svg
                ...
                <form className='mt-4 w-full flex flex-col gap-y-2'>
                            ...
                            <div className='flex flex-col justify-between'>
                                <div className='flex flex-row gap-x-2'>
                                    ...
                                    <Button
                                        size='sm'
                                        variant='outlined'
                                        // onClick={() => dispatch(setOpenCreateHR(false))}
                    ...
                    <div className='flex flex-row gap-x-4'>
                        ...
                        <div className='mb-1 flex flex-col gap-4 w-1/2 custom-form'>
                            <Typography variant='h6' color='blue-gray' className='-mb-3'>
                                Ngày sinh
                            </Typography>
