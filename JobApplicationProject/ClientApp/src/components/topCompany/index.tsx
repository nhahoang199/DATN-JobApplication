...
function TopCompanySection() {
    ...
    return (
        <section className='py-6 overflow-auto bg-gray-100 dark:bg-gray-800 dark:text-gray-100'>
            <div className='container flex flex-col items-center justify-center p-4 mx-auto 3xl:w-3/4 h-1000 sm:p-10'>
                <p className='p-2 text-sm font-medium text-center uppercase tracki'>Trusted partner</p>
                <h1 className='mb-16 text-4xl font-bold text-center leadi sm:text-5xl'>Top những công ty nổi bật</h1>
                    ...
                    {data.map((item, index) => (
                        <div className='flex flex-col justify-center w-full px-8 mx-6 my-12 text-center bg-white rounded-lg shadow-lg lg:w-72 3xl:w-96 3xl:h-52 dark:text-gray-800 3xl:mx-12'>
                            ...
                            <div className='flex-1 my-4'>
                                <p className='text-xl font-semibold leadi 3xl:mb-4'>{item.name}</p>
                                <p>{item.title}</p>
                            </div>
