                    ...
                    <div className='flex flex-col grow ml-4'>
                        <div className='flex flex-row justify-between'>
                            ...
                            <PencilSquareIcon
                                ...
                                onClick={() => dispatch(setOpenEditCompanyContact(true))}
                            />
                        </div>
                            ...
                            <div className='flex flex-row gap-x-6'>
                                <div className='mb-1 flex flex-row gap-4 w-1/2 items-center'>
                                    <div className='bg-blue-gray-100 flex items-center justify-center w-10 h-10 rounded-sm'>
                                        <GlobeAltIcon className='h-5 w-5 cursor-pointer text-blue-gray-800' />
                                    </div>
                                ...
                                <div className='mb-1 flex flex-row gap-4 w-1/2 items-center'>
                                    <div className='bg-blue-gray-100 flex items-center justify-center w-10 h-10 rounded-sm'>
                                        <svg
                                            ...
                                            viewBox='0 0 50 50'
                                            fill='currentColor'
                                            className='w-5 h-5 text-blue-gray-800 duration-200 cursor-pointer hover:scale-110'
                                        >
