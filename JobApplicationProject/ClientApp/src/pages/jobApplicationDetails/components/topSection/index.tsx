...
function JobDescDetailsTopSection(props: { item: IJobApplicationModel }) {
    const { item } = props
            ...
            <CardBody className='flex flex-row w-full p-4 divide-x-2 rounded-md'>
                ...
                <div className='flex flex-col gap-y-5 grow '>
                    <Typography
                        variant='paragraph'
                        color='gray'
                        className={`${userRole === 'BASICUSER' ? 'hidden' : ''} -mb-3 italic text-gray-500`}
                    >
                        Việc làm
                    </Typography>
                    <Typography
                        ...
                        <Popover placement='bottom-start' open={openPopover} handler={setOpenPopover}>
                            <PopoverHandler {...triggers}>
                                <div className='flex flex-row items-center gap-3'>
                                    <Avatar src={avepoint} alt={'company-avatar'} size='sm' />
