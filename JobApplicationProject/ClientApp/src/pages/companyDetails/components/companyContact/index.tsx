        ...
        <Card className='w-full shadow-lg rounded-xl'>
            <CardBody className='flex lg:p-4 lg:pb-0 3xl:p-6 overflow-x-wrap break-words'>
                <Typography
                    variant='h6'
                    color='blue-gray'
                    className='mt-4 mx-2 pb-4 w-full !line-clamp-2 cursor-default border-b border-solid'
                >
                    Liên hệ
                </Typography>
            </CardBody>
            <CardFooter className='flex flex-col items-center pt-0 pb-2 pl-6 divide-y divide-dashed hover:divide-solid'>
                <div className='flex items-center justify-between w-full h-14 item'>
                    <Typography className='flex items-start text-sm text-gray-500' color='gray'>
                        <GlobeAltIcon className='w-5 h-5 mr-2 text-sm' />
                        Website:
                    </Typography>
                    <a
                        href='#zx'
                ...
                <div className='flex items-center justify-center space-x-4 w-full h-12'>
                    ...
                    >
                        <svg
                            ...
                            viewBox='0 0 20 20'
                            fill='currentColor'
                            className='w-8 h-6 text-gray-900 duration-200 cursor-pointer hover:scale-110'
                        >
