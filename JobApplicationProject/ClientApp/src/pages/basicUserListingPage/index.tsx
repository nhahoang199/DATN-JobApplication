...
const TABLE_HEAD = ['Tên người dùng', 'Số diện thoại', 'Email', 'Ngày sinh', 'Giới tính', 'Ngày đăng ký', 'Trạng thái']
...
export default function BasicUserListingPage() {
    ...
    return (
        <>
                    ...
                    <div className='mb-4 mt-2 flex items-start justify-between gap-8'>
                        <div className='pl-0 '>
                            ...
                            <Typography color='gray' className='mt-1 font-normal'>
                                Xem tất cả người dùng sử dụng hệ thống
                            </Typography>
                        </div>
            ...
            <ThemeProvider value={mtTheme}>
                ...
                <ConfirmDialog
                    open={openDelete}
                    message={'Bạn có muốn ngừng hoạt động công ty này không?'}
